...
if [ "$LOCAL" != "$REMOTE" ]; then
    ...
    # NUR Python Dateien und Docker-Files streams-ru.jsson, self_update.sh ,holen
    git checkout origin/main -- *.py Dockerfile docker-compose.yml streams-ru.json self_update.sh
